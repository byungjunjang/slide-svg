...
```bash
python3 .codex/skills/slide/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p ".codex/skills/slide/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `.codex/skills/slide/templates/layouts/`; project templates go to `<project_path>/templates/`
>
...
```bash
ls -la ".codex/skills/slide/templates/layouts/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 .codex/skills/slide/scripts/svg_quality_checker.py ".codex/skills/slide/templates/layouts/<template_id>" --format <canvas_format>
```
...
Update `.codex/skills/slide/templates/layouts/layouts_index.json`:
...
**Template Path**: `.codex/skills/slide/templates/layouts/<template_id>/`
**Category**: <category>
