...
#   .codex/skills/slide/scripts/_py.sh path/to/script.py [args...]
#   .codex/skills/slide/scripts/_py.sh -c "import …"
...
# 4) Nothing usable — fail loudly with a fix, instead of silently running a stub.
{
  ...
  echo "                  .venv/Scripts/pip install -r .codex/skills/slide/requirements.txt"
  echo "    macOS/Linux:  python3 -m venv .venv"
  echo "                  .venv/bin/pip install -r .codex/skills/slide/requirements.txt"
