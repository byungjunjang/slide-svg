...
**Mandatory rules:**
1. Search for availability: `grep <keyword> assets/icons/icons_index.txt` (Claude Code, full library). In claude.ai mode the index is absent — use `ls .codex/skills/slide/templates/icons/{{TOKEN:assets.icon-pack-default}}/` to see what's bundled (~20 essentials).
