...
```bash
python3 -c "import json; t=json.load(open('.codex/skills/slide/references/theme-active.json')); print(t['name'])"
```

Then read the preset's design vocabulary:

```
.codex/skills/slide/templates/layouts/<preset>/DESIGN.md
```
...
1. `.codex/skills/slide/references/chart-rhetorical-roles.md` — `chart_strategy` enum
2. `.codex/skills/slide/references/slide-role-enum.md` — `slide_role` enum + diagnostic ratios
3. `.codex/skills/slide/references/anti-slop-core.md` — theme-agnostic anti-patterns (Layer 1 R1–R5 alignment)
...
```bash
python3 .codex/skills/slide-plan/scripts/validate_plan.py output/<project>/slide_plan.json
```
...
```json
{
  ...
  "design_dependency": {
    ...
    "design_md_path": ".codex/skills/slide/templates/layouts/<preset>/DESIGN.md",
...
| File | Role |
|---|---|
| `.codex/skills/slide/templates/layouts/<preset>/DESIGN.md` | `recommended_layout_family` enum + chart treatment |
| `.codex/skills/slide/references/chart-rhetorical-roles.md` | `chart_strategy` enum + chart template mapping |
| `.codex/skills/slide/references/slide-role-enum.md` | `slide_role` enum + arc defaults + diagnostic ratios |
| `.codex/skills/slide/references/anti-slop-core.md` | structural anti-patterns |
| `.codex/skills/slide-plan/scripts/validate_plan.py` | R1–R5 + enum + diagnostic ratio enforcement |
