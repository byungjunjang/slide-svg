...
**Mandatory rules:**
1. Search for availability: `grep <keyword> assets/icons/icons_index.txt` (Claude Code, full library). In claude.ai mode the index is absent — use `ls .claude/skills/slide/templates/icons/tabler-outline/` to see what's bundled (~20 essentials).
