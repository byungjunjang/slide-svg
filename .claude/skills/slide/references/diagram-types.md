...
> (`.claude/skills/diagram-design/`) and the `/slide` native-DrawingML pipeline.
...
|---|---|---|
| Components + connections in a system | **Architecture** | `.claude/skills/diagram-design/references/type-architecture.md` |
...
`.claude/skills/diagram-design/references/style-guide.md`. This bridge stays theme-agnostic so a
