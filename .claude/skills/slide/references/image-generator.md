...
> `minimal flat illustration, line-art style, muted / pastel tones, transparent background, no gradients, no glow, no 3D rendering, no photorealism, harmonized with warm off-white (#FAFAF9) backdrop and single indigo (#4633E3) accent`

**Deck Style Anchor** (shared prefix for all images in a deck):
> `Jangpm lecture deck illustration — minimal flat line-art, muted pastel tones aligned with #4633E3 indigo accent and #FAFAF9 off-white, transparent background`
...
|-------------|-------------|---------------|
| **Jangpm (locked default)** | Minimal flat line-art, muted pastel | `minimal flat illustration`, `line-art style`, `muted pastel tones`, `transparent background`, `no gradients`, `no glow`, `harmonized with #4633E3 indigo accent` |
...
```
color palette: warm off-white (#FAFAF9) background, muted pastel midtones harmonized with indigo-violet (#4633E3) single accent, neutral grays (#1A1A1A text, #6B7280 secondary)
```
