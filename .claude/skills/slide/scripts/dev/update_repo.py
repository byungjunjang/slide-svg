...
Usage:
    python3 .claude/skills/slide/scripts/dev/update_repo.py
    python3 .claude/skills/slide/scripts/dev/update_repo.py --skip-pip
"""
...
# dev/update_repo.py -> scripts/ -> slide/ -> skills/ -> .claude/ -> slide-svg/
