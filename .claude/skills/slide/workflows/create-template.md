...
```bash
python3 .claude/skills/slide/scripts/pptx_template_import.py "<reference_template.pptx>"
```
...
```bash
mkdir -p ".claude/skills/slide/templates/layouts/<template_id>"
```

> **Output location**: Global templates go to `.claude/skills/slide/templates/layouts/`; project templates go to `<project_path>/templates/`
>
...
```bash
ls -la ".claude/skills/slide/templates/layouts/<template_id>"
```

Run SVG validation on the template directory:

```bash
python3 .claude/skills/slide/scripts/svg_quality_checker.py ".claude/skills/slide/templates/layouts/<template_id>" --format <canvas_format>
```
...
Update `.claude/skills/slide/templates/layouts/layouts_index.json`:
...
**Template Path**: `.claude/skills/slide/templates/layouts/<template_id>/`
**Category**: <category>
