#!/usr/bin/env python3
"""Render design-system.md from design-system.tpl.md + theme-active.json.

Regenerated by init_theme.py every time theme-active.json changes. Hand edits
to design-system.md will be overwritten — edit the template instead.
"""
...
DEFAULT_TPL = SKILL_ROOT / "references" / "design-system.tpl.md"
DEFAULT_OUT = SKILL_ROOT / "references" / "design-system.md"
